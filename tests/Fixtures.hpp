...
protected:
    ...
    void SetUp() override{
        array_int = new DynamicArray<int>(data_int);
        array_str = new DynamicArray<const char*>(data_str);
    }
...
protected:
    ...
    void SetUp() override{
        List_int = new LinkedList<int>(data_int);
        List_str = new LinkedList<const char*>(data_str);
    }
...
protected:
    ...
    void SetUp() override{
        seq_int = new ArraySequence<int>(data_int);
        seq_str = new ArraySequence<const char*>(data_str);
    }
...
protected:
    ...
    void SetUp() override{
        seq_int = new ListSequence<int>(data_int);
        seq_str = new ListSequence<const char*>(data_str);
    }
...
protected:
    ...
    void SetUp() override{
        Sequence = new MutableBitSequence<char>(data_bits);
    }
